...
const deleteAttractionFromDayRoute = require("./routes/deleteAttractionFromDay");
const PackageFavoritedattractionsRouter = require("./routes/PackageFavoritedattractions");
...
app.use("/deleteAttractionFromDay", deleteAttractionFromDayRoute);
app.use("/getPackageFavoritedattractions", PackageFavoritedattractionsRouter);
